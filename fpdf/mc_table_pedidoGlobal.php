...
function Header()
{
    ...
    // Title
	$this->Cell(98,8,'',0,0,'');
	$this->Cell(98,8,'Pedido Global',0,1,'R');
	$this->SetFont('Arial','B',12);
	$this->Cell(98,5,'',0,0,'');
	date_default_timezone_set('America/Chihuahua');
	$this->Cell(98,5,date('d-m-Y H:i'),0,1,'R');
	$this->Cell(196,5,'',0,1,'L');
	$this->SetFont('Arial','B',8);
	$this->Cell(49,5,'Impreso por',0,0,'L');
	$this->Cell(49,5,'E-mail',0,0,'L');
	$this->Cell(49,5,'',0,0,'L');
	$this->Cell(49,5,utf8_decode('Página'),0,1,'L');
	$this->SetFont('Arial','',8);
	$this->Cell(49,5,$_SESSION["name"],0,0,'L');
	$this->Cell(49,5,$_SESSION["email"],0,0,'L');
	$this->Cell(49,5,'',0,0,'L');
	...
	$this->SetWidths(array(16,40,65,35,20,20));
	$this->Row(array("Cantidad",utf8_decode("Código"),"Producto","Proveedor","Precio","Importe"));
