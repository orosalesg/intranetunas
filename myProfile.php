        ...
        <form action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>" 
            ...
            <label for="confirmpwd">Confirm password</label><input type="password" 
                   ...
                   onclick="return regformhash(this.form,
                                   ...
                                   this.form.email,
                                   this.form.password,
                                   this.form.confirmpwd);" /><input class="btn" style="background-color:#F00;" value="Cancel" type="button" onclick="javascript:location.href='http://channels.supportmeraki.com/dealreg.php'" />
        </form>
