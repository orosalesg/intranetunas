            ...
            var _fnDrawCallBackWithGrouping = function (oSettings) {
                ...
                for (var i = 0; i < nTrs.length; i++) {
                    ...
                    if (sLastGroup == null || sGroup != sLastGroup) {
						...
						sGroupCleaned = sGroupCleaned.replace(/[^A-Z0-9]/ig,"_");
                        ...
                        nCell.innerHTML = properties.sGroupLabelPrefix + (sGroup === "" ? properties.sEmptyGroupLabel : sGroup);// + "<div class='totalSN' id='totalSN-" + nGroup.id + "'>Alo!</div>";
